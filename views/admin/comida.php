...
<body>
    ...
    <main>
        <section class="container_form">
            ...
            <form action="/controllers/admin/ComidaController.php" method="post">
                ...
                <table border="1">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[6][tipo_producto]" value="racion">
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[7][tipo_producto]" value="racion">
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[8][tipo_producto]" value="racion">
                        </td>
                ...
                <table border="1">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[9][tipo_producto]" value="racion">
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[10][tipo_producto]" value="racion">
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[11][tipo_producto]" value="racion">
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[12][tipo_producto]" value="racion">
                        </td>
                ...
                <table border="1">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[13][tipo_producto]" value="racion">
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[14][tipo_producto]" value="racion">
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="comidas[15][tipo_producto]" value="racion">
                        </td>
